...
class AgentsClient {
    ...
    get link() {
        var _a;
        return ((_a = this._link) !== null && _a !== void 0 ? _a : (this._link = new Client_2.LinkClient(this._options)));
    }
    get knowledgeBase() {
        var _a;
        return ((_a = this._knowledgeBase) !== null && _a !== void 0 ? _a : (this._knowledgeBase = new Client_1.KnowledgeBaseClient(this._options)));
    }
    get llmUsage() {
        var _a;
        return ((_a = this._llmUsage) !== null && _a !== void 0 ? _a : (this._llmUsage = new Client_3.LlmUsageClient(this._options)));
    }
    /**
